#!/usr/bin/env Rscript
library(phytools)
#This script is intended to remove branch lengths from trees, such as would be useful in preparing trees for MCMCTree.  This file can just be combined with drop_support.R for a single script if desired.  Would save a small amount of time reloading the phytools library etc.
...
# you can run the script from in R by loading your tree below:
...
# write your tree below if you loaded manually:
